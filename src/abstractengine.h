...
public:
   ...
   */
  AbstractEngine (string filename, int ntasks_per_worker);
...
public:
  /**
    ...
    */
    static AbstractEngine* getAbstractEngineInstance(const string& filename,
      const string& type="", int ntasks_per_worker = 1);
